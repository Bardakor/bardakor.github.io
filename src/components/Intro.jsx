    ...
    return (
        <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
            ...
            <div className="max-w-xl text-sm mb-6">
                ...
                <p className="mb-3 font-bold">My love for football stems from my experience as a former player at Arsenal during my teenage years. I am also an accomplished software developer, having designed several video games. You can check out my projects on my <a href="https://github.com/Bardakor" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-green-500 transition duration-300">GitHub page</a>.</p>
            </div>
        </div>
