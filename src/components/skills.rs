        ...
        <section class="skills-section grid grid-cols-2 md:grid-cols-12 border-b">
            ...
            {s.buckets.into_iter().map(|b| {
                let cls = match b.color.as_str() {
                    "blue"   => "skill-bucket col-span-1 md:col-span-3 p-[clamp(16px,2.5vw,32px)] flex flex-col justify-center border-r border-b bg-blue text-white",
                    "yellow" => "skill-bucket col-span-1 md:col-span-3 p-[clamp(16px,2.5vw,32px)] flex flex-col justify-center border-r border-b bg-yellow text-black",
                    _        => "skill-bucket col-span-1 md:col-span-3 p-[clamp(16px,2.5vw,32px)] flex flex-col justify-center border-r border-b",
                };
                view! {
                    <div class=cls>
